package com.vcwdfca.ecofor0.block.fabricator;
...
public class FabricatorController extends BlockEFabricatorController implements IPatternAddition, IControllerLevelDisplay {
    ...
    public void setDynamicPattern() {
        ...
        parts.addBlock(0, -1, 1, info(BlockEFabricatorPatternBus.INSTANCE));
        parts.addBlock(0, -1, 0, info(FabricatorParallelProc.L13.getStateFromMeta(2)));
        parts.addBlock(0, 0, 0, info(BlockEFabricatorWorker.INSTANCE.getStateFromMeta(2)));
        parts.addBlock(0, 0, 1, info(BlockEFabricatorVent.INSTANCE.getStateFromMeta(2)));
        parts.addBlock(0, 1, 1, info(BlockEFabricatorPatternBus.INSTANCE));
        parts.addBlock(0, 1, 0, info(FabricatorParallelProc.L13.getStateFromMeta(2)));
